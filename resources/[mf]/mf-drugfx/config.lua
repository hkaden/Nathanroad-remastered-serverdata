Config = {
  ...
  Items = {
    ['weed1g'] = {
      ...
      quality = 0.7,              -- quality of drug/effect strength modifier   float           (0.1 - 2.0)
      ...
      effects = {
        ...
        add_armor     = 20,      -- add armor to player?        false or int    (0-100)
        add_health    = false,    -- add health to player?       false or int    (0-100)
        take_armor    = 30,    -- take armor from player?     false or int    (0-100)
        take_health   = 20,    -- take health from player?    false or int    (0-100)
