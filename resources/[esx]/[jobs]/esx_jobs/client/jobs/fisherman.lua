Config.Jobs.fisherman = {
	...
	Zones = {
		...
		BoatDeletePoint = {
			Pos   = {x = 3858.65, y = 4485.16, z = 0.39},
			Size  = {x = 13.0, y = 13.0, z = 8.0},
			Color = {r = 255, g = 0, b = 0},
			Marker= 1,
			Blip  = false,
		...
		VehicleDeletePoint = {
			Pos   = {x = 1698.17, y = 4807.95, z = 41.86},
		...
		Delivery = {
			Pos   = {x = 1724.11, y = 4801.07, z = 41.68},
			Color = {r = 204, g = 204, b = 0},
			...
			GPS   = {x = 1724.11, y = 4801.07, z = 41.68},
			Item = {
				{
				name   = _U('delivery'),
				time   = 500,
