...
RegisterNetEvent('esx_vangelico_robbery:client:sendToDispatch', function()
    TriggerServerEvent('esx_vangelico_robbery:server:sendToDispatch', exports['cd_dispatch']:GetPlayerInfo())
end)
...
AddEventHandler('esx_vangelico_robbery:robberycomplete', function(robb)
    ...
    ESX.UI.Notify('info', _U('robbery_complete'))
    store = ""
    incircle = false
end)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        for k, v in pairs(Stores) do
            ...
            if (dist < 15.0) then
                if not holdingup then
                    DrawMarker(1, pos2 - 1, 0, 0, 0, 0, 0, 0, 2.001, 2.0001, 0.5001,
                        0, 155, 255, 200, 0, 0, 0, 0)
                    if (dist < 1.0) then
                        ...
                        if IsPedShooting(ped) then
                            -- ESX.TriggerServerCallback('esx_vangelico_robbery:getEvent', function(event_is_running)
        ...
        if holdingup then
            -- if #(pos - vector3(-626.5326, -238.3758, 38.05)) < 0.5 then
			if #(pos - vector3(-626.5326, -238.3758, 38.05)) < 0.5 then
				...
				DisplayHelpText(_U('field'))
                    if IsControlJustReleased(1, 51) then
                        ...
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -626.5326, -238.3758, 38.05, 0.0, 0.0, 0.0,
            ...
            if #(pos - vector3(-625.6032, -237.5273, 38.05)) < 0.5 then
                if (hasrobbed2 == false) then
                    ...
                    if IsControlJustReleased(1, 51) then
                        ...
                        SetPtfxAssetNextCall("scr_jewelheist")
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -625.6032, -237.5273, 38.05, 0.0, 0.0, 0.0,
                            1.0, false, false, false, false)
                        loadAnimDict("missheist_jewel")
                        TaskPlayAnim(player, "missheist_jewel", "smash_case", 8.0, 1.0, -1, 2, 0, 0, 0, 0)
                        DisplayHelpText(_U('collectinprogress'))
            ...
            if #(pos - vector3(-626.9178, -235.5166, 38.05)) < 0.5 then
                if (hasrobbed3 == false) then
                    ...
                    if IsControlJustReleased(1, 51) then
                        ...
                        SetPtfxAssetNextCall("scr_jewelheist")
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -626.9178, -235.5166, 38.05, 0.0, 0.0, 0.0,
                            1.0, false, false, false, false)
                        loadAnimDict("missheist_jewel")
                        TaskPlayAnim(player, "missheist_jewel", "smash_case", 8.0, 1.0, -1, 2, 0, 0, 0, 0)
                        DisplayHelpText(_U('collectinprogress'))
            ...
            if #(pos - vector3(-625.6701, -234.6061, 38.05)) < 0.5 then
                if (hasrobbed4 == false) then
                    ...
                    if IsControlJustReleased(1, 51) then
                        ...
                        SetPtfxAssetNextCall("scr_jewelheist")
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -625.6701, -234.6061, 38.05, 0.0, 0.0, 0.0,
                            1.0, false, false, false, false)
                        loadAnimDict("missheist_jewel")
                        TaskPlayAnim(player, "missheist_jewel", "smash_case", 8.0, 1.0, -1, 2, 0, 0, 0, 0)
                        DisplayHelpText(_U('collectinprogress'))
            ...
            if #(pos - vector3(-626.8935, -233.0814, 38.05)) < 0.5 then
                if (hasrobbed5 == false) then
                    ...
                    if IsControlJustReleased(1, 51) then
                        ...
                        SetPtfxAssetNextCall("scr_jewelheist")
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -626.8935, -233.0814, 38.05, 0.0, 0.0, 0.0,
                            1.0, false, false, false, false)
                        loadAnimDict("missheist_jewel")
                        TaskPlayAnim(player, "missheist_jewel", "smash_case", 8.0, 1.0, -1, 2, 0, 0, 0, 0)
                        DisplayHelpText(_U('collectinprogress'))
            ...
            if #(pos - vector3(-627.9514, -233.8582, 38.05)) < 0.5 then
                if (hasrobbed6 == false) then
                    ...
                    if IsControlJustReleased(1, 51) then
                        ...
                        SetPtfxAssetNextCall("scr_jewelheist")
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -627.9514, -233.8582, 38.05, 0.0, 0.0, 0.0,
                            1.0, false, false, false, false)
                        loadAnimDict("missheist_jewel")
                        TaskPlayAnim(player, "missheist_jewel", "smash_case", 8.0, 1.0, -1, 2, 0, 0, 0, 0)
                        DisplayHelpText(_U('collectinprogress'))
            ...
            if #(pos - vector3(-624.5250, -231.0555, 38.05)) < 0.5 then
                if (hasrobbed7 == false) then
                    ...
                    if IsControlJustReleased(1, 51) then
                        ...
                        SetPtfxAssetNextCall("scr_jewelheist")
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -624.5250, -231.0555, 38.05, 0.0, 0.0, 0.0,
                            1.0, false, false, false, false)
                        loadAnimDict("missheist_jewel")
                        TaskPlayAnim(player, "missheist_jewel", "smash_case", 8.0, 1.0, -1, 2, 0, 0, 0, 0)
                        DisplayHelpText(_U('collectinprogress'))
            ...
            if #(pos - vector3(-623.0003, -233.0833, 38.05)) < 0.5 then
                if (hasrobbed8 == false) then
                    ...
                    if IsControlJustReleased(1, 51) then
                        ...
                        SetPtfxAssetNextCall("scr_jewelheist")
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -623.0003, -233.0833, 38.05, 0.0, 0.0, 0.0,
                            1.0, false, false, false, false)
                        loadAnimDict("missheist_jewel")
                        TaskPlayAnim(player, "missheist_jewel", "smash_case", 8.0, 1.0, -1, 2, 0, 0, 0, 0)
                        DisplayHelpText(_U('collectinprogress'))
            ...
            if #(pos - vector3(-620.1098, -233.3672, 38.05)) < 0.5 then
                if (hasrobbed9 == false) then
                    ...
                    if IsControlJustReleased(1, 51) then
                        ...
                        SetPtfxAssetNextCall("scr_jewelheist")
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -620.1098, -233.3672, 38.05, 0.0, 0.0, 0.0,
                            1.0, false, false, false, false)
                        loadAnimDict("missheist_jewel")
                        TaskPlayAnim(player, "missheist_jewel", "smash_case", 8.0, 1.0, -1, 2, 0, 0, 0, 0)
                        DisplayHelpText(_U('collectinprogress'))
            ...
            if #(pos - vector3(-620.2979, -234.4196, 38.05)) < 0.5 then
                if (hasrobbed10 == false) then
                    ...
                    if IsControlJustReleased(1, 51) then
                        ...
                        SetPtfxAssetNextCall("scr_jewelheist")
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -620.2979, -234.4196, 38.05, 0.0, 0.0, 0.0,
                            1.0, false, false, false, false)
                        loadAnimDict("missheist_jewel")
                        TaskPlayAnim(player, "missheist_jewel", "smash_case", 8.0, 1.0, -1, 2, 0, 0, 0, 0)
                        DisplayHelpText(_U('collectinprogress'))
            ...
            if #(pos - vector3(-619.0646, -233.5629, 38.05)) < 0.5 then
                if (hasrobbed11 == false) then
                    ...
                    if IsControlJustReleased(1, 51) then
                        ...
                        SetPtfxAssetNextCall("scr_jewelheist")
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -619.0646, -233.5629, 38.05, 0.0, 0.0, 0.0,
                            1.0, false, false, false, false)
                        loadAnimDict("missheist_jewel")
                        TaskPlayAnim(player, "missheist_jewel", "smash_case", 8.0, 1.0, -1, 2, 0, 0, 0, 0)
                        DisplayHelpText(_U('collectinprogress'))
            ...
            if #(pos - vector3(-617.4846, -230.6598, 38.05)) < 0.5 then
                if (hasrobbed12 == false) then
                    ...
                    if IsControlJustReleased(1, 51) then
                        ...
                        SetPtfxAssetNextCall("scr_jewelheist")
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -617.4846, -230.6598, 38.05, 0.0, 0.0, 0.0,
                            1.0, false, false, false, false)
                        loadAnimDict("missheist_jewel")
                        TaskPlayAnim(player, "missheist_jewel", "smash_case", 8.0, 1.0, -1, 2, 0, 0, 0, 0)
                        DisplayHelpText(_U('collectinprogress'))
            ...
            if #(pos - vector3(-618.3619, -229.4285, 38.05)) < 0.5 then
                if (hasrobbed13 == false) then
                    ...
                    if IsControlJustReleased(1, 51) then
                        ...
                        SetPtfxAssetNextCall("scr_jewelheist")
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -618.3619, -229.4285, 38.05, 0.0, 0.0, 0.0,
                            1.0, false, false, false, false)
                        loadAnimDict("missheist_jewel")
                        TaskPlayAnim(player, "missheist_jewel", "smash_case", 8.0, 1.0, -1, 2, 0, 0, 0, 0)
                        DisplayHelpText(_U('collectinprogress'))
            ...
            if #(pos - vector3(-619.6064, -230.5518, 38.05)) < 0.5 then
                if (hasrobbed14 == false) then
                    ...
                    if IsControlJustReleased(1, 51) then
                        ...
                        SetPtfxAssetNextCall("scr_jewelheist")
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -619.6064, -230.5518, 38.05, 0.0, 0.0, 0.0,
                            1.0, false, false, false, false)
                        loadAnimDict("missheist_jewel")
                        TaskPlayAnim(player, "missheist_jewel", "smash_case", 8.0, 1.0, -1, 2, 0, 0, 0, 0)
                        DisplayHelpText(_U('collectinprogress'))
            ...
            if #(pos - vector3(-620.8951, -228.6519, 38.05)) < 0.5 then
                if (hasrobbed15 == false) then
                    ...
                    if IsControlJustReleased(1, 51) then
                        ...
                        SetPtfxAssetNextCall("scr_jewelheist")
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -620.8951, -228.6519, 38.05, 0.0, 0.0, 0.0,
                            1.0, false, false, false, false)
                        loadAnimDict("missheist_jewel")
                        TaskPlayAnim(player, "missheist_jewel", "smash_case", 8.0, 1.0, -1, 2, 0, 0, 0, 0)
                        DisplayHelpText(_U('collectinprogress'))
            ...
            if #(pos - vector3(-619.7905, -227.5623, 38.05)) < 0.5 then
                if (hasrobbed16 == false) then
                    ...
                    if IsControlJustReleased(1, 51) then
                        ...
                        SetPtfxAssetNextCall("scr_jewelheist")
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -619.7905, -227.5623, 38.05, 0.0, 0.0, 0.0,
                            1.0, false, false, false, false)
                        loadAnimDict("missheist_jewel")
                        TaskPlayAnim(player, "missheist_jewel", "smash_case", 8.0, 1.0, -1, 2, 0, 0, 0, 0)
                        DisplayHelpText(_U('collectinprogress'))
            ...
            if #(pos - vector3(-620.6110, -226.4467, 38.05)) < 0.5 then
                if (hasrobbed17 == false) then
                    ...
                    if IsControlJustReleased(1, 51) then
                        ...
                        SetPtfxAssetNextCall("scr_jewelheist")
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -620.6110, -226.4467, 38.05, 0.0, 0.0, 0.0,
                            1.0, false, false, false, false)
                        loadAnimDict("missheist_jewel")
                        TaskPlayAnim(player, "missheist_jewel", "smash_case", 8.0, 1.0, -1, 2, 0, 0, 0, 0)
                        DisplayHelpText(_U('collectinprogress'))
            ...
            if #(pos - vector3(-623.9951, -228.1755, 38.05)) < 0.5 then
                if (hasrobbed18 == false) then
                    ...
                    if IsControlJustReleased(1, 51) then
                        ...
                        SetPtfxAssetNextCall("scr_jewelheist")
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -623.9951, -228.1755, 38.05, 0.0, 0.0, 0.0,
                            1.0, false, false, false, false)
                        loadAnimDict("missheist_jewel")
                        TaskPlayAnim(player, "missheist_jewel", "smash_case", 8.0, 1.0, -1, 2, 0, 0, 0, 0)
                        DisplayHelpText(_U('collectinprogress'))
            ...
            if #(pos - vector3(-624.8832, -227.8645, 38.05)) < 0.5 then
                if (hasrobbed19 == false) then
                    ...
                    if IsControlJustReleased(1, 51) then
                        ...
                        SetPtfxAssetNextCall("scr_jewelheist")
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -624.8832, -227.8645, 38.05, 0.0, 0.0, 0.0,
                            1.0, false, false, false, false)
                        loadAnimDict("missheist_jewel")
                        TaskPlayAnim(player, "missheist_jewel", "smash_case", 8.0, 1.0, -1, 2, 0, 0, 0, 0)
                        DisplayHelpText(_U('collectinprogress'))
            ...
            if #(pos - vector3(-623.6746, -227.0025, 38.05)) < 0.5 then
                if (hasrobbed20 == false) then
                    ...
                    if IsControlJustReleased(1, 51) then
                        ...
                        SetPtfxAssetNextCall("scr_jewelheist")
                        StartParticleFxLoopedAtCoord("scr_jewel_cab_smash", -623.6746, -227.0025, 38.05, 0.0, 0.0, 0.0,
                            1.0, false, false, false, false)
                        loadAnimDict("missheist_jewel")
                        TaskPlayAnim(player, "missheist_jewel", "smash_case", 8.0, 1.0, -1, 2, 0, 0, 0, 0)
                        DisplayHelpText(_U('collectinprogress'))
            ...
            if (hasrobbed == true) and (hasrobbed2 == true) and (hasrobbed3 == true) and (hasrobbed4 == true) and
                (hasrobbed5 == true) and (hasrobbed6 == true) and (hasrobbed7 == true) and (hasrobbed8 == true) and
                (hasrobbed9 == true) and (hasrobbed10 == true) and (hasrobbed11 == true) and (hasrobbed12 == true) and
                (hasrobbed13 == true) and (hasrobbed14 == true) and (hasrobbed15 == true) and (hasrobbed16 == true) and
                (hasrobbed17 == true) and (hasrobbed18 == true) and (hasrobbed19 == true) and (hasrobbed20 == true) then
                holdingup = false
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if pos then
            ...
            if GetDistanceBetweenCoords(GetEntityCoords(playerPed), 706.669, -966.898, 30.413, true) <= 5 then
