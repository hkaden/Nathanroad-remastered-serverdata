Config = {
	...
	ExtrasEnabled = false,				-- This toggles the extra commands (Shirt, Pants) in case you dont want your players stripping their clothes for whatever reason.
	...
	GUI = {
		...
		Key = "RBRACKET", 				-- Change the GUI key here for keymapping. https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
