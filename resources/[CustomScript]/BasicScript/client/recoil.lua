...
-- 	[-1074790547] = 0.000, -- ASSAULT RIFLE
-- 	[961495388] = 0.005, -- ASSAULT RIFLE MK2
-- 	[-2084633992] = 0.000, -- CARBINE RIFLE
...
local recoils = {
	...
	-- Handguns
	[`WEAPON_AKM`] = 0.4,			--['weapon_pistol']
	[`WEAPON_M9A3`] = 0.3,			--['weapon_pistol']
	...
	[-2084633992] = 0.1,		--['weapon_carbinerifle']
