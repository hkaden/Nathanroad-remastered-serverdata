...
function MFL:StartMinigame(funcname,itemdata,notitext)
  ...
  Citizen.CreateThread(function(...)
    ...
    if doCont then
      ...
      if pinsLeft <= 0 then
        didWin = true
        ESX.UI.Notify('info', notitext)
      end
      self.IsPlaying = false
      print("FIN",didWin, point)
      TriggerServerEvent(funcname, pins, point, itemdata)
      -- TriggerEvent('MF_LockPicking:MinigameComplete', didWin, point)
      -- TriggerServerEvent('MF_LockPicking:MinigameComplete', didWin, point)
