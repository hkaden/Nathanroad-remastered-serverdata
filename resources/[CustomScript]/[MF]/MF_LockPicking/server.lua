...
function MFL:MinigameComplete(source,didWin, point)
...
AddEventHandler('MF_LockPicking:MinigameComplete', function(didWin) MFL:MinigameComplete(source,didWin, point); end)
