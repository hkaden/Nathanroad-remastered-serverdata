...
AddEventHandler("scotty:license_" .. CTKRASl28ynBWRE748s, function(SRCvMsbc, yv2saZdOgB8z3JwQ)
...
AddEventHandler("scotty:failsafe_" .. CTKRASl28ynBWRE748s, function(wheV)
    if aQoknv then
...
diJzRMLOjU_4fkAazQvVM = function(XS)
    local MmVf5V2Qg1wRpv9leYO = GetCurrentResourceName() ~= CTKRASl28ynBWRE748s and XS["0sTbwhTM"] or
                                    CTKRASl28ynBWRE748s
    ...
    Citizen.CreateThread(function()
        ...
        while U4YXjx7s == nil and wjANBYdATS2bjl7lr_mt > GetGameTimer() do
            TriggerEvent(N_v1PGp9zZwh4Dx["EventRoute"] and N_v1PGp9zZwh4Dx["EventRoute"]["ESX_CLIENT"] or
                             "esx:getSharedObject", function(l71qIDjh4Jxn7coGGgm)
        ...
        SendNUIMessage({
            ...
            ["EUwDgMyI"] = GetCurrentResourceName() ~= CTKRASl28ynBWRE748s and N_v1PGp9zZwh4Dx["0sTbwhTM"] or nil
        })
    end)
    ...
    RegisterNUICallback("Close", function(UhWrB6WGYysJZkW, kR_zZi0g6RQjwuaV)
    ...
    local lTg = 0
    RegisterNUICallback("Continue", function(dUQqwDuH, TcXZ__qwTiVmpicU)
    ...
    AddEventHandler("scotty-gachapon:StartWheel", function(KnlAL_J4aT8, djJZ82ppup6LVtZOtYwP, uDs7W1)
        ...
        for gePRF7Y, C5y1g79rkR in pairs(URhm2SZ_pEXk1SbR.list) do
            ...
            if C5y1g79rkR.name then
                ...
                ZuF = C5y1g79rkR["item"] or C5y1g79rkR["money"] and "cash" or C5y1g79rkR["black_money"] and
                          "black_money" or C5y1g79rkR["vehicle"]
            ...
            elseif C5y1g79rkR["black_money"] then
                sxn7R8x7GxC_k = "$" .. CWhSDwS8cnu(C5y1g79rkR["black_money"]) .. "<br><small>(" ..
            ...
            table.insert(jTmyGiMyB, {
                ["name"] = sxn7R8x7GxC_k,
                ["image"] = ZuF,
                ["chance"] = HoYhrXY3rlpq(C5y1g79rkR["tier"]),
                ["color"] = ge3c0KeISB(C5y1g79rkR["tier"]),
                ["type"] = C5y1g79rkR["item"] and "item" or C5y1g79rkR["money"] and "money" or C5y1g79rkR["black_money"] and
                    "black_money" or C5y1g79rkR["vehicle"] and "vehicle" or "unknown"
            })
        end
        if not N_v1PGp9zZwh4Dx["disable_blur"] then
            IX3g02gJjHa()
    ...
    AddEventHandler("scotty-gachapon:top_message", function(jdoFu2, DNq, YXhJNk, ko)
    ...
    AddEventHandler("onResourceStop", function(AQwRuaqUA)
