...
cfg = {
    ...
    commandSuggestion = '開啟動作選單', -- Open the animations panel suggestion
    commandNameEmote = 'e', -- Play an animation by command
    commandNameSuggestion = '做動作', -- Play an animation by command suggestion
    keyActive = false, -- Use key for opening the panel
    keyLetter = 'F5', -- Which key for opening the panel if cfg.keyActive is true
    keySuggestion = '開啟動作選單', -- Suggestion on keybind mapping
    ...
    defaultEmoteKey = 65 -- Default emote command key
}