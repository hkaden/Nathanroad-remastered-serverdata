...
Config.TimeLeftAfter = 7 -- time remaining after one player betted (dealer actions start timeout)
Config.PlayerDecideTime = 7 -- player decide time (when watching our cards)
