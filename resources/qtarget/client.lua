...
local function EnableTarget()
	...
	while targetActive do
		...
		local hit, coords, distance, entity, entityType = RaycastCamera(curFlag, playerCoords)
...
-- Debug Option
RegisterCommand('printzone', function()
	TriggerEvent('table', Zones)
end)
RegisterCommand('printbone', function()
	TriggerEvent('table', Bones)
end)
RegisterCommand('printentity', function()
	TriggerEvent('table', Entities)
end)
RegisterCommand('printmodel', function()
	TriggerEvent('table', Models)
end)
