...
function orig_addProximityCheck(ply)
	...
	local distance = GetConvar('voice_useNativeAudio', 'false') == 'true' and voiceModeData[1] * 3 or voiceModeData[1] or megaphone

	return #(plyCoords - GetEntityCoords(tgtPed)) < distance or megaphone
end
