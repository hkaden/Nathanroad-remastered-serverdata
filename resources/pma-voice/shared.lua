...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		{1.5, "細聲"}, -- Whisper speech distance in gta distance units
		{3.0, "正常"}, -- Normal speech distance in gta distance units
		{6.0, "大叫"}, -- Shout speech distance in gta distance units
		{10.0, "大聲公"} -- Shout speech distance in gta distance units
	}
else
	Cfg.voiceModes = {
		{3.0, "細聲"}, -- Whisper speech distance in gta distance units
		{7.0, "正常"}, -- Normal speech distance in gta distance units
		{15.0, "大叫"}, -- Shout speech distance in gta distance units
		{25.0, "大聲公"} -- Shout speech distance in gta distance units
	}
end
