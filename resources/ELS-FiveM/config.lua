outputLoading = GetConvar("els_outputLoading", "false") == "false"
playButtonPressSounds = true
printDebugInformation = GetConvar("els_debug", "false") == "false"
...
developerMode = GetConvar("els_developer", "false") == "false"
