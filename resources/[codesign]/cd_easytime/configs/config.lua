...
Config.Command = {
    ...
    Perms = { --You decide which permission groups can use the staff command ^.
        ['esx'] = {'superadmin', 'admin', 'mod', 'jpadminsuperadmin', 'jpadminadmin'},
        ['qbcore'] = {'god', 'admin'},
...
Config.TsunamiWarning = false --Do you want to enable the tsunami warning countdown just before a server restart?
...
Config.SnowChance = 0 --The percent chance for it to snow out of 100.
