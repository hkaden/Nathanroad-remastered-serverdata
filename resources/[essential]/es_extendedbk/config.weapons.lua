...
Config.Weapons = {
	-- Custom Weapon
	{
		...
		components = {
			{name = 'w_sr_toz_mag1', label = "Clip 1", hash = `COMPONENT_TOZ_CLIP_01`},
			{name = 'w_sr_toz_mag2', label = "Clip 2", hash = `COMPONENT_TOZ_CLIP_02`},
			{name = 'w_sr_toz_mag3', label = "Clip 3", hash = `COMPONENT_TOZ_CLIP_03`},
			{name = 'w_sr_toz_mag4', label = "Clip 4", hash = `COMPONENT_TOZ_CLIP_04`},
			{name = 'w_sr_toz_stock1', label = "前托 1", hash = `COMPONENT_TOZ_STOCK_01`},
			{name = 'w_sr_toz_stock2', label = "前托 2", hash = `COMPONENT_TOZ_STOCK_02`},
			{name = 'w_sr_toz_stock3', label = "前托 3", hash = `COMPONENT_TOZ_STOCK_03`},
			{name = 'w_sr_toz_stock4', label = "前托 4", hash = `COMPONENT_TOZ_STOCK_04`},
			{name = 'w_sr_toz_stock5', label = "前托 5", hash = `COMPONENT_TOZ_STOCK_05`}
		}
	},
	-- Melee
