...
function CreateExtendedPlayer(playerId, identifier, group, accounts, job, name, coords, phone, iban)
	local self = {}
	...
	self.addInventoryItem = function(name, count, metadata, slot)
		local whData = {
			message = self.name .. ' addInventoryItem',
			sourceIdentifier = self.identifier,
	...
	self.setMaxWeight = function(newWeight)
		...
		return exports.NR_Inventory:Inventory(self.source):set('weight', newWeight)
	end
