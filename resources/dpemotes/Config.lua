...
Config.Languages = {
  ['en'] = {
        ...
        ['propemotes'] = "📦 道具",
        ['favoriteemotes'] = "🌟 已收藏",
        ['favoriteinfo'] = "收藏一個已選取的動作",
        ['rfavorite'] = "清空收藏列表",
        ['prop2info'] = "❓ Prop Emotes can be located at the end",
        ['set'] = "將 (",
        ['setboundemote'] = ") 綁定到~g~CapsLock~w~鍵?",
        ['newsetemote'] = "~w~ 已綁定, 按下 ~g~CapsLock~w~ 使用",
        ['cancelemote'] = "取消動作",
        ['cancelemoteinfo'] = "按~r~X~w~ 取消目前的動作",
        ['walkingstyles'] = "步姿",
        ['resetdef'] = "重設至預設值",
        ['normalreset'] = "正常 (重設)",
        ['moods'] = "心情",
        ...
        ['nocancel'] = "沒有動作可以取消",
        ['maleonly'] = "此動作只有男性可用",
        ['emotemenucmd'] = "輸入 /emotemenu 打開此選單",
        ['shareemotes'] = "👫 雙人動作",
        ['shareemotesinfo'] = "遨請附近的人使用作用",
        ['sharedanceemotes'] = "🕺 雙人舞蹈",
        ['notvalidsharedemote'] = "是無效的雙人動用",
        ['sentrequestto'] = "已將動作請求傳送給 ~y~",
        ['nobodyclose'] = "~r~附近~w~ 的人不足夠.",
        ['doyouwanna'] = "按下 ~y~Y~w~ 接受, ~r~L~w~ 拒絕 (~g~",
        ['refuseemote'] = "動作已被拒絕",
