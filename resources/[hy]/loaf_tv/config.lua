...
Strings = {
    ['VideoHelp'] = '輸入 ~b~/tvs ~y~Youtube ID~s~ 播放Youtube影片.\n 例如: ~b~/tvs ~y~WrJVW9Z43OA~s~',
    ['VolumeHelp'] = '輸入 ~b~/volume ~y~(0-10)~s~ 調較音量.\n例如: ~b~/volume ~y~5~s~\n\n輸入 ~b~/tvs ~y~Youtube ID~s~ 轉播Youtube影片.\n例如: ~b~/tvs ~y~WrJVW9Z43OA~s~\n\n輸入 ~b~/destroy~s~ 停止播放\n\n ~INPUT_CONTEXT~ 與玩家同步影片時間',
}