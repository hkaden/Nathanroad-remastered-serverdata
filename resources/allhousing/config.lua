Config = {
  ...
  BlipEmptyColor      = 0,     -- must be set regardless of option above.
  ...
  CreationJobs = {   
    admin = {                        -- JOB NAME.
      ...
      account = 'admin',     -- society account name
    ...
    realestateagent = {                    -- JOB NAME.
      minRank = 2,                    -- min rank to create house.
      society = true,                -- use society accounts?
      account = 'realestate', -- society account name
      payCut  = 1,                    -- % of sale earnt by player, rest goes to realestate society account (if using esx_society, else goes nowhere).
    },
  },
  ...
  PoliceJobs = {
    police = {      -- JOB NAME
      minRank = 6,  -- min rank to raid house
    },
    police2 = {     -- JOB NAME
