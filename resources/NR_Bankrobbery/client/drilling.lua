...
local function SetupScaleform(scaleform)
    ...
    ButtonMessage("停止") -- the message to display next to it
    PopScaleformMovieFunctionVoid()
...
AddEventHandler('NR_Bankrobbery:drilling:start', Drilling.Start)
AddEventHandler('NR_Bankrobbery:drilling:stop', Drilling.Stop)
