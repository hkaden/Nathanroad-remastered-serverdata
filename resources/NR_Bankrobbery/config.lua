...
Config = {
	...
	PoliceJobs = {"police"}, -- Jobs that can't do bankrobberies etc, but can secure the banks.
	FetchJobs = 10, -- timer in seconds to fetch online players from each dealership jobs
...
Config.Banks = {
	[1] = {
		name = '太平洋標準銀行',
		blip = {enable = true, name = "銀行 | 太平洋標準銀行", pos = vector3(231.67,214.91,106.28), display = 4, sprite = 431, color = 5, scale = 0.7},
		police = 3,
		medic = 1,
		inUse = false, -- do not touch!

		keypads = {
			['start'] = {pos = vector3(262.35,223.03,106.78), text = {[1] = '~r~[E]~s~ 入侵門鎖', [2] = '~y~[G]~s~ 使用通行證'} , hacked = false},
			['vault'] = {pos = vector3(252.81,228.49,102.08), text = {[1] = '~r~[E]~s~ 入侵金庫控制終端', [2] = '~y~[G]~s~ 使用通行證'}, hacked = false},
		},
		...
		safes = {
			[1] = {
				...
				cash = {enable = true, min = 300000, max = 350000}
			},
			[2] = {
		...
		powerBox = {
			...
			freeTime = 0, -- time in seconds before police is alerted
			hackAdd = {enable = true, time = 30}, -- extra time added upon successful hacking
		},

		pettyCash = {
			[1] = {pos = vector3(242.64,226.22,106.29), robbed = false, reward = {dirty = true, min = 15000, max = 25000}},
			[2] = {pos = vector3(247.76,224.27,106.29), robbed = false, reward = {dirty = true, min = 15000, max = 25000}},
			[3] = {pos = vector3(252.88,222.43,106.29), robbed = false, reward = {dirty = true, min = 15000, max = 25000}},
		},
		...
		reqItems = { -- required items for pacific & settings:
			['hacking'] = { -- do not touch ID's
				{name = 'hacker_device', amount = 1, remove = true, chance = 50}, -- item name, amount required, remove/not remove, chance to remove in %.
	...
	[2] = {
		name = '沙漠銀行',
		blip = {enable = true, name = '銀行 | 沙漠銀行', pos = vector3(-110.94,6462.53,31.64), display = 4, sprite = 431, color = 5, scale = 0.7},
		police = 3,
		medic = 1,
		inUse = false, -- do not touch!

		keypads = {
			['start'] = {pos = vector3(-105.9,6472.11,31.9), text = '~r~[E]~s~ 入侵門鎖', hacked = false},
			['vault'] = {pos = vector3(-105.51,6475.23,32.0), text = '~r~[E]~s~ 入侵金庫控制終端', hacked = false},
		},
		...
		pettyCash = {
			[1] = {pos = vector3(-113.64,6471.93,31.63), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
			[2] = {pos = vector3(-112.32,6470.57,31.63), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
			[3] = {pos = vector3(-111.27,6469.51,31.63), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
		},
	...
	[3] = {
		name = '城市銀行 [大眾廣場分行]', -- name of the bank
		blip = {enable = true, name = '銀行 | 城市銀行 [大眾廣場分行]', pos = vector3(150.87,-1037.16,29.34), display = 4, sprite = 431, color = 5, scale = 0.7},
		police = 3,
		medic = 1, -- required cops
		inUse = false, -- do not touch!

		keypads = {
			['start'] = {pos = vector3(147.35,-1046.24,29.37), text = '~r~[E]~s~ 入侵門鎖', hacked = false},
			['vault'] = {pos = vector3(148.52,-1046.57,29.60), text = '~r~[E]~s~ 入侵金庫控制終端', hacked = false},
		},
		...
		safes = {
			[1] = {
				...
				cash = {enable = true,  min = 220000, max = 270000},
			},
			[2] = {
		...
		pettyCash = {
			[1] = {pos = vector3(151.13,-1042.27,29.37), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
			[2] = {pos = vector3(149.7,-1041.73,29.37), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
			[3] = {pos = vector3(148.08,-1041.10,29.37), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
		},
	...
	[4] = {
		name = '城市銀行 [頂尖分行]', -- name of the bank
		blip = {enable = true, name = '銀行 | 城市銀行 [頂尖分行]', pos = vector3(315.32,-275.55,53.92), display = 4, sprite = 431, color = 5, scale = 0.7},
		police = 3,
		medic = 1, -- required cops
		inUse = false, -- do not touch!

		keypads = {
			['start'] = {pos = vector3(311.69,-284.55,54.16), text = '~r~[E]~s~ 入侵門鎖', hacked = false},
			['vault'] = {pos = vector3(312.87,-284.99,54.39), text = '~r~[E]~s~ 入侵金庫控制終端', hacked = false},
		},
		...
		pettyCash = {
			[1] = {pos = vector3(315.42,-280.56,54.17), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
			[2] = {pos = vector3(313.7,-279.89,54.17), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
			[3] = {pos = vector3(312.08,-279.37,54.17), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
		},
	...
	[5] = {
		name = '城市銀行 [伯頓分行]', -- name of the bank
		blip = {enable = true, name = '銀行 | 城市銀行 [伯頓分行]', pos = vector3(-349.89,-46.44,49.04), display = 4, sprite = 431, color = 5, scale = 0.7},
		police = 3,
		medic = 1, -- required cops
		inUse = false, -- do not touch!

		keypads = {
			['start'] = {pos = vector3(-353.52,-55.47,49.20), text = '~r~[E]~s~ 入侵門鎖', hacked = false},
			['vault'] = {pos = vector3(-352.22,-55.77,49.23), text = '~r~[E]~s~ 入侵金庫控制終端', hacked = false},
		},
		...
		pettyCash = {
			[1] = {pos = vector3(-349.61,-51.40,49.05), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
			[2] = {pos = vector3(-351.3,-50.80,49.05), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
			[3] = {pos = vector3(-353.09,-50.20,49.05), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
		},
	...
	[6] = {
		name = '城市銀行 [全福分行]', -- name of the bank
		blip = {enable = true, name = '銀行 | 城市銀行 [全福分行]', pos = vector3(-1214.44,-327.5,37.67), display = 4, sprite = 431, color = 5, scale = 0.7},
		police = 3,
		medic = 1, -- required cops
		inUse = false, -- do not touch!

		keypads = {
			['start'] = {pos = vector3(-1210.49,-336.44,37.98), text = '~r~[E]~s~ 入侵門鎖', hacked = false},
			['vault'] = {pos = vector3(-1209.30,-335.73, 37.97), text = '~r~[E]~s~ 入侵金庫控制終端', hacked = false},
		},
		...
		pettyCash = {
			[1] = {pos = vector3(-1210.58,-330.75,37.78), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
			[2] = {pos = vector3(-1211.99,-331.45,37.78), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
			[3] = {pos = vector3(-1213.63,-332.28,37.78), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
		},
	...
	[7] = {
		name = '城市銀行 [海洋公路分行]', -- name of the bank
		blip = {enable = true, name = '銀行 | 城市銀行 [海洋公路分行]', pos = vector3(-2966.28,483.01,15.69), display = 4, sprite = 431, color = 5, scale = 0.7},
		police = 3,
		medic = 1, -- required cops
		inUse = false, -- do not touch!

		keypads = {
			['start'] = {pos = vector3(-2956.55,482.1,15.99), text = '~r~[E]~s~ 入侵門鎖', hacked = false},
			['vault'] = {pos = vector3(-2956.44,483.35, 15.87), text = '~r~[E]~s~ 入侵金庫控制終端', hacked = false},
		},
		...
		pettyCash = {
			[1] = {pos = vector3(-2961.43,484.62,15.73), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
			[2] = {pos = vector3(-2961.52,482.99,15.73), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
			[3] = {pos = vector3(-2961.59,481.25,15.73), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
		},
	...
	[8] = {
		name = '城市銀行 [沙漠分行]', -- name of the bank
		blip = {enable = true, name = '銀行 | 城市銀行 [沙漠分行]', pos = vector3(1175.13,2703.09,38.17), display = 4, sprite = 431, color = 5, scale = 0.7},
		police = 3,
		medic = 1, -- required cops
		inUse = false, -- do not touch!

		keypads = {
			['start'] = {pos = vector3(1175.64,2712.85,38.30), text = '~r~[E]~s~ 入侵門鎖', hacked = false},
			['vault'] = {pos = vector3(1174.37,2712.85,38.26), text = '~r~[E]~s~ 入侵金庫控制終端', hacked = false},
		},
		...
		pettyCash = {
			[1] = {pos = vector3(1173.16,2707.86,38.11), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
			[2] = {pos = vector3(1174.9,2707.87,38.11), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
			[3] = {pos = vector3(1176.59,2707.86,38.11), robbed = false, reward = {dirty = true, min = 10000, max = 20000}},
		},
...
Config.Camera = {
	[1] = {pos = {153.15,-1042.05,29.37}, heading = 44.32, name = '城市銀行 [Legion Square] Cam #1'},
	[2] = {pos = {143.1,-1042.76,29.37}, heading = 235.08, name = '城市銀行 [Legion Square] Cam #2'},
	[3] = {pos = {149.73,-1051.26,29.35}, heading = 16.87, name = '城市銀行 [Legion Square] Cam #3'},
	--
	[4] = {pos = {317.63,-280.51,54.16}, heading = 46.96, name = '城市銀行 [Alta] Cam #1'},
	[5] = {pos = {307.43,-281.14,54.16}, heading = 229.91, name = '城市銀行 [Alta] Cam #2'},
	[6] = {pos = {314.07,-289.63,54.14}, heading = 24.06, name = '城市銀行 [Alta] Cam #3'},
	--
	[7] = {pos = {-347.51,-51.26,49.04}, heading = 44.82, name = '城市銀行 [Burton] Cam #1'},
	[8] = {pos = {-357.61,-51.92,49.04}, heading = 230.92, name = '城市銀行 [Burton] Cam #2'},
	[9] = {pos = {-350.91,-60.51,49.01}, heading = 28.09, name = '城市銀行 [Burton] Cam #3'},
	--
	[10] = {pos = {-1209.33,-329.2,37.78}, heading = 83.18, name = '城市銀行 [Rockford Hills] Cam #1'},
	[11] = {pos = {-1215.84,-336.86,37.78}, heading = 270.99, name = '城市銀行 [Rockford Hills] Cam #2'},
	[12] = {pos = {-1205.0,-338.07,37.76}, heading = 66.41, name = '城市銀行 [Rockford Hills] Cam #3'},
	--
	[13] = {pos = {1171.39,2706.91,38.09}, heading = 243.26, name = '城市銀行 [Grand Senora Desert] Cam #1'},
	[14] = {pos = {1180.68,2710.88,38.09}, heading = 63.94, name = '城市銀行 [Grand Senora Desert] Cam #2'},
	[15] = {pos = {1171.55,2716.84,38.07}, heading = 226.04, name = '城市銀行 [Grand Senora Desert] Cam #3'},
	--
	[16] = {pos = {-2962.26,486.62,15.7}, heading = 158.82, name = '城市銀行 [Great Ocean Highway] Cam #1'},
	[17] = {pos = {-2958.7,477.21,15.7}, heading = 341.95, name = '城市銀行 [Great Ocean Highway] Cam #2'},
	[18] = {pos = {-2952.44,485.95,15.68}, heading = 134.42, name = '城市銀行 [Great Ocean Highway] Cam #3'},
	--
