...
Config.DoorList = {
	...
	-- 	slides = false,
	-- 	doors = {
	-- 		{objHash = 1255028970, objHeading = 300.9768371582, objCoords = vector3(-801.9663, -224.5216, 37.88036)},
	-- 		{objHash = 1255028970, objHeading = 120.11769104004, objCoords = vector3(-803.039, -222.5891, 37.88036)}
	-- 	},
	...
	-- 	maxDistance = 2.0,
	-- 	audioRemote = false,
	-- 	objCoords = vector3(-783.6136, -214.8961, 37.23173),
	-- 	authorizedJobs = { ['cardealer']=0 },
	-- 	locked = true,
	-- 		-- oldMethod = true,
	-- 		-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
	...
	-- 	maxDistance = 6.0,
	-- 	audioRemote = false,
	-- 	objCoords = vector3(-770.6477, -239.9535, 37.42771),
	-- 	authorizedJobs = { ['cardealer']=0 },
	-- 	locked = true,
	-- 		-- oldMethod = true,
	-- 		-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
